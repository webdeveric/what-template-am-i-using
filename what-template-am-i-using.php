...
class What_Template_Am_I_Using
{
    ...
    public static function setup()
    {
        ...
        if (! is_admin() && current_user_can('edit_theme_options')) {
            ...
            if ($user instanceof WP_User && $user->wtaiu_show_sidebar == '1') {
        ...
        <tr>
            ...
            <td>
                <fieldset>
                    ...
                    <label for="wtaiu_show_sidebar"><input type="checkbox" name="wtaiu_show_sidebar" id="wtaiu_show_sidebar" value="1" <?php checked('1', $user->wtaiu_show_sidebar); ?> />
                        <?php _e('Show the sidebar when viewing site', 'wtaiu'); ?>
                    </label>
                </fieldset>
            </td>
        </tr>
